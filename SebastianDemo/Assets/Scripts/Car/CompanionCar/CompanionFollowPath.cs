...
namespace PathfindingForCars
{
    ...
    public class CompanionFollowPath : MonoBehaviour
    {
        ...
        private CompanionCarController carScript;

        //The script with companion car data
        ...
        void Start()
        {
            carScript = GetComponent<CompanionCarController>();
        ...
        void ChangeSpeed()
        {
            ...
            float currentHeading = compCarData.GetHeading();
        ...
        float CalculateProgress()
        {
            ...
            Vector3 carPos = compCarData.GetRearWheelPos();
        ...
        Vector3 CalculateCarPos()
        {
            ...
            if (wayPoints[currentWayPointIndex].isReversing)
            {
                carPos = compCarData.GetRearWheelPos();
            }
