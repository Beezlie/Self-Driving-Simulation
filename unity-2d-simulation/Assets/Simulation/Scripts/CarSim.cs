...
namespace RosSharp.RosBridgeClient
{
    public class CarSim : MonoBehaviour
    {
        ...
        void Update()
        {
            carController.treadmillVelCallback(new Messages.Geometry.Twist());      // temporary
            ...
            carController.syncCallback(new Pose(transform.position, transform.rotation), new Messages.Geometry.Twist());        //temporary
